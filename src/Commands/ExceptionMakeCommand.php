...
class ExceptionMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new lumen Exception ';
     ...
     * @var string
     */
    protected $type = 'Exception';  // command type
    ...
    {
        return dirname(__DIR__) . '/stubs/exception.stub';
    }
